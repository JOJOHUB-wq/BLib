...
public enum Version {
    ...
    public static boolean is1_21_5orNewer() {
        return VERSION.newerThanOrEqual(V1_21_5);
    }

    public static boolean is1_21_5orOlder() {
        return VERSION.olderThanOrEqual(V1_21_5);
    }
    ...
    public static boolean is1_21_6orNewer() {
        return VERSION.newerThanOrEqual(V1_21_6);
    }

    public static boolean is1_21_6orOlder() {
        return VERSION.olderThanOrEqual(V1_21_6);
    }
    ...
    public static boolean is1_21_7orNewer() {
        return VERSION.newerThanOrEqual(V1_21_7);
    }

    public static boolean is1_21_7orOlder() {
        return VERSION.olderThanOrEqual(V1_21_7);
    }
    ...
    public static boolean is1_21_8orNewer() {
        return VERSION.newerThanOrEqual(V1_21_8);
    }

    public static boolean is1_21_8orOlder() {
        return VERSION.olderThanOrEqual(V1_21_8);
    }
